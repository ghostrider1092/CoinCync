...
How to run the public JSON-RPC + REST API at `https://api.coincync.network`. Lives in [`/deploy/api/`](https://git.coincync.network/coincync/cync-protocol/tree/main/deploy/api).
