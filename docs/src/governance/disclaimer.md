...
- **Read the source.** It's MIT licensed and available at [github.com/CoinCync/Coincync-Testnet-](https://github.com/CoinCync/Coincync-Testnet-). Don't run cryptocurrency software you haven't reviewed.
...
CoinCync is licensed under the MIT License. The full text is in [`LICENSE`](https://github.com/CoinCync/Coincync-Testnet-/blob/main/LICENSE) at the repository root. The relevant clause:
...
- [`SECURITY.md`](https://github.com/CoinCync/Coincync-Testnet-/blob/main/SECURITY.md) at the repository root — the responsible-disclosure process for security issues
