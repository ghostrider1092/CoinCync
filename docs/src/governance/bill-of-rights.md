...
The authoritative source is [`docs/BILL_OF_RIGHTS.md`](https://github.com/CoinCync/Coincync-Testnet-/blob/main/docs/BILL_OF_RIGHTS.md) at the repository root. This page reproduces it in full for the published docs site. **If this page ever drifts from the repository file, trust the repository file.**
...
- [`docs/BILL_OF_RIGHTS.md`](https://github.com/CoinCync/Coincync-Testnet-/blob/main/docs/BILL_OF_RIGHTS.md) — the authoritative source
