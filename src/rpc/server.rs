...
pub async fn start_rpc_server(
    ...
    module
        .register_method("get_block_by_height", |params, state, _ext| {
            crate::rpc::handlers::chain::get_block_by_height(params, &state)
        })
        .map_err(|e| Error::RpcError(e.to_string()))?;
    ...
    module
        .register_method("get_block", |params, state, _ext| {
            crate::rpc::handlers::chain::get_block(params, &state)
        })
        .map_err(|e| Error::RpcError(e.to_string()))?;
    ...
    // and tracked.
    module
        .register_method("get_transaction", |params, state, _ext| {
            crate::rpc::handlers::chain::get_transaction(params, &state)
        })
        .map_err(|e| Error::RpcError(e.to_string()))?;
    ...
    module
        .register_method("get_block_range", |params, state, _ext| {
            crate::rpc::handlers::chain::get_block_range(params, &state)
        })
        .map_err(|e| Error::RpcError(e.to_string()))?;
    ...
    module
        .register_method("get_blocks_batch", |params, state, _ext| {
            crate::rpc::handlers::chain::get_blocks_batch(params, &state)
        })
        .map_err(|e| Error::RpcError(e.to_string()))?;
